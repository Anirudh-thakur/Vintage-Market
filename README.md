# Vintage-Market
e-commerce platform for a used clothing shop using Spring Boot and React with features features such as product browsing, searching, purchasing, and secure checkout, with a responsive user interface.
